...
// import { useGlobalContext } from '../context/GlobalProvider'; // Add this import
   ...
   <SafeAreaView className="bg-primary h-full">
      <ScrollView>
        ...
        <View className='W-full justify-center min-h-[85vh] px-4 my-6'>
          ...
          <Text className='text-2xl text-white text-semibold mt-10 font-psemibold'>Log in to Attendance</Text>
